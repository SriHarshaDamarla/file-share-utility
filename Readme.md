...
- How to use:
  1. Create a .env file in server folder with BASE*FILE_PATH variable pointing to the home directory to be shown in UI.  
     \_Note: Do not add file separator at the end of path it can cause some issues*
  2. Create a .env file in UI folder with VITE_API_BASE_IP_PORT variable pointing to the server instance and port that is currently running
